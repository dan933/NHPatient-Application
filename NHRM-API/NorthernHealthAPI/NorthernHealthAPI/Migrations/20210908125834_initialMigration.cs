        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MeasurementName = table.Column<string>(maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RoleID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StaffType = table.Column<string>(maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    MeasurementID = table.Column<int>(nullable: false),
                    DataPointNumber = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RecordTypeID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RecordType = table.Column<string>(maxLength: 50, nullable: false),
                    RecordCategoryID = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Prompt = table.Column<string>(maxLength: 12, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ResourceDialogID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Heading = table.Column<string>(maxLength: 60, nullable: false),
                    Content = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    URNumber = table.Column<string>(maxLength: 50, nullable: false),
                    Email = table.Column<string>(maxLength: 256, nullable: false),
                    ...
                    HomeNumber = table.Column<string>(maxLength: 10, nullable: true),
                    CountryOfBirth = table.Column<string>(maxLength: 50, nullable: false),
                    PreferredLanguage = table.Column<string>(maxLength: 50, nullable: false),
                    Password = table.Column<byte[]>(fixedLength: true, maxLength: 64, nullable: false),
                    Salt = table.Column<string>(nullable: false),
                    LivesAlone = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MeasurementRecordID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DateTimeRecorded = table.Column<DateTime>(type: "datetime", nullable: false),
                    MeasurementID = table.Column<int>(nullable: false),
                    CategoryID = table.Column<int>(nullable: false),
