...
namespace NorthernHealthAPI.Controllers
{
    ...
    public class PatientController : ControllerBase
    {
        ...
        [AllowAnonymous]
        [HttpGet, Route("patient/{urNumber}")]
        ...
        [HttpGet, Route("frequency/{urNumber}")]
       ...
       // [HttpGet, Route("getFrequency/{urNumber}"), Authorize(Roles = "Patient")]
        [HttpGet, Route("getFrequency/{urNumber}")]
        ...
        [HttpGet, Route("disabledMeasurements/{urNumber}")]
        ...
        [HttpPost, Route("recordmeasurement")]
